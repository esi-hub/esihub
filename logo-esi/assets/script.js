...
if(document.getElementById("resize_value").value==0){
...
var playGround = function(){
	...
	document.getElementsByTagName("svg")[0].setAttribute("width", resizeValue+"px");
	...
	var fileRename = "Logo_ESI-" + resizeValue + "px.png";
